    ...
    <div className="space-y-6">
        ...
        <div className="card">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-ink">
                {roles.reduce((sum, r) => sum + r._count.rolePermissions, 0)}
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        {roles.map((role) => (
          <div key={role.id} className="card hover:shadow-lg transition-shadow">
            ...
            {/* Description */}
            {role.description && (
              <p className="text-sm text-ink-muted64 mb-4">{role.description}</p>
            )}
      ...
      <div className="card bg-gradient-to-br from-blue-50 to-indigo-50 border-blue-200">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h4 className="text-sm font-bold text-ink mb-1">💡 Thông tin về Roles</h4>
            <ul className="text-xs text-ink-muted64 space-y-1">
              ...
              <li>• <strong>TEACHER:</strong> Xem lịch dạy, điểm danh lớp mình</li>
