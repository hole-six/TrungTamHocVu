                    ...
                    <td className={`py-2 font-medium ${t.voidedAt ? "line-through" : ""}`}>
                      {t.type === "MAINTENANCE" ? (
                        t.amount > 0 ? (
                          ...
                          <div>
                            <p className={t.voidedAt ? "font-semibold text-ink-muted48" : "font-semibold text-emerald-700"}>Tự bảo dưỡng</p>
                    ...
                    <div className="text-right">
                      {t.type === "MAINTENANCE" ? (
                        t.amount > 0 ? (
                          ...
                          <>
                            <p className={`text-sm font-semibold ${t.voidedAt ? "text-ink-muted48 line-through" : "text-emerald-700"}`}>Tự bảo dưỡng</p>
                            <p className="mt-0.5 text-[10px] text-ink-muted48">Không mất chi phí</p>
                          </>
                        )
                      ) : (
                        <>
