...
const NAV_ITEMS = [
  ...
  { href: "/guardians", label: "Phụ huynh", icon: Icon.guardians, color: "from-indigo-500 to-indigo-600" },
  ...
  { href: "/inventory", label: "Kho sách", icon: Icon.inventory, color: "from-teal-500 to-teal-600" },
