...
export default function PayrollLineEditor({ lineId, bonus, penalty, employeeName }: { lineId: string; bonus: number; penalty: number; employeeName: string }) {
  ...
  return (
    <div className="flex min-w-[250px] flex-col items-end gap-3 rounded-2xl border border-[#fed7aa] bg-[#fffaf5] p-3">
      <p className="w-full text-left text-[11px] font-bold uppercase tracking-[0.18em] text-[#c2410c]">
        Điều chỉnh cho {employeeName}
      </p>
      ...
      <div className="flex flex-wrap justify-end gap-2">
        ...
        <ConfirmActionButton
          ...
          tone="danger"
          disabled={loading}
          className="inline-flex items-center gap-1.5 rounded-lg border-2 border-red-200 bg-white px-3 py-1.5 text-xs font-bold text-red-600 transition-all hover:bg-red-50"
