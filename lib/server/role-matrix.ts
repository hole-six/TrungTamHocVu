...
export const ROLE_MATRIX: Record<ModuleKey, Record<RoleCode, AccessLevel>> = {
  ...
  // BRANCH_MANAGER/DIRECTOR nâng lên FULL (trước là APPROVE_VIEW) — quản lý cơ sở/giám
  // đốc phải tự chấm/sửa công được chứ không chỉ duyệt, theo yêu cầu thực tế vận hành.
  timesheet: {
    SUPER_ADMIN: "FULL", BOARD: "VIEW", BRANCH_MANAGER: "FULL", REGISTRAR: "CREATE_VIEW", ADMISSIONS: "NONE", ACCOUNTANT: "VIEW",
